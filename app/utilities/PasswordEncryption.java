...
/**
 * A singleton class to hash passwords and check passwords vs hashed values. It uses a combination of hashing and unique
 * salt. The algorithm used is PBKDF2WithHmacSHA1 which, although not the best for hashing password (vs. bcrypt) is
 * still considered robust and is based on a stack overflow post that can be found
 * <a href="http://security.stackexchange.com/a/6415/12614">here</a>. The hashed value has 256 bits.
 */
